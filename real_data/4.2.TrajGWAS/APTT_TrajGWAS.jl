...
# sbatch -J TrajGWAS --mem=5G -t 1-0:0 --array=1-22 -o log/%A_%a.log --wrap='julia /gdata01/user/xuhe/family_relatedness/real_data-2022-12-29/4.trajgwas/APTT_TrajGWAS.jl $SLURM_ARRAY_TASK_ID'
...
nm = open(deserialize, "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/null_fitter/APTT_nm_un.jls")
...
pvalfile = join(["/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/temp_pvalues/APTT/chr", n_cpu, ".trajgwas.txt"])
