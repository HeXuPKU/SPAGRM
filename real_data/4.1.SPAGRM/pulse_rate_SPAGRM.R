...
# library(GRAB)
# 
# ResidMatFile.beta = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/null_fitter/pulse_rate_beta_resid.txt"
# ResidMatFile.tau = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/null_fitter/pulse_rate_tau_resid.txt"
# 
...
# 
# # ~ 11 minutes on node04.
# SPAGRM.beta = SPAGRM.NullModel(ResidMatFile.beta,
#                                SparseGRMFile,
#                                PairwiseIBDFile)
# 
# save(SPAGRM.beta,
#      file = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/pulse_rate.SPAGRM.beta.RData")
# 
# # ~ 18 minutes on node04.
# SPAGRM.tau = SPAGRM.NullModel(ResidMatFile.tau,
#                               SparseGRMFile,
#                               PairwiseIBDFile)
# 
# save(SPAGRM.tau,
#      file = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/pulse_rate.SPAGRM.tau.RData")


###### part2 analyzing ######
# cd "/gdata01/user/xuhe/family_relatedness/real_data-2022-12-29/"
# sbatch -J prstep2 --mem=10G -t 1-0:0 --array=1-22 -o log/%A_%a.log --wrap='Rscript /gdata01/user/xuhe/family_relatedness/real_data-2022-12-29/4.EmpSPA/pulse_rate_SPAGRM.R $SLURM_ARRAY_TASK_ID'
...
OutputDir = paste0("/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/temp_pvalues/pulse_rate/chr", n.cpu)
...
precond.beta = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/pulse_rate.SPAGRM.beta.RData"
load(precond.beta)
...
precond.tau = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/pulse_rate.SPAGRM.tau.RData"
load(precond.tau)
