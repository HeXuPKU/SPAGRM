...
# library(GRAB)
# 
# ResidMatFile.beta = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/null_fitter/VD_beta_resid.txt"
# ResidMatFile.tau = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/null_fitter/VD_tau_resid.txt"
# 
...
# 
# save(SPAGRM.beta,
#      file = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/VD.SPAGRM.beta.RData")
# 
...
# 
# save(SPAGRM.tau,
#      file = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/VD.SPAGRM.tau.RData")


###### part2 analyzing ######
# cd "/gdata01/user/xuhe/family_relatedness/real_data-2022-12-29/"
# sbatch -J VDstep2 --mem=5G -t 3-0:0 --array=1-22 -o log/%A_%a.log --wrap='Rscript /gdata01/user/xuhe/family_relatedness/real_data-2022-12-29/4.EmpSPA/VD_SPAGRM.R $SLURM_ARRAY_TASK_ID'
...
OutputDir = paste0("/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/temp_pvalues/VD/chr", n.cpu)
...
precond.beta = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/VD.SPAGRM.beta.RData"
load(precond.beta)
...
precond.tau = "/gdata01/user/xuhe/SPA-GRM/real_data-2022-12-29/preconding/VD.SPAGRM.tau.RData"
load(precond.tau)
